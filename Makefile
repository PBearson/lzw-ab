...
TEST_TARGETS ?= test_decompression_raw_decoded test_decompression_raw_encoded test_decompression_json_encoded test_decompression_raw_encoded_revised test_decompression_json_encoded_revised
...
test_decompression_json_encoded_revised: $(LZW_IMPL_DEPS) $(CJSON_DEPS) $(SRC)/base64.c $(TESTS)/test_decompression_json_encoded_revised.c
	$(BUILD_CMD) -D DATA_STRUCT_V3
